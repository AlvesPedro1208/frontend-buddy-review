...
const MetaAdsTable = ({
  ...
  useEffect(() => {
    ...
    console.log('MetaAdsTable - tableContainer:', tableContainer);
    console.log('MetaAdsTable - scrollContainer:', scrollContainer);
    console.log('MetaAdsTable - camposSelecionados length:', camposSelecionados.length);
